...
namespace TeksBebasAPI
{
    public partial class EmotionClassificationModel
    {
        public const string RetrainFilePath =  @"E:\College\Projects\Final Thesis\codes\static\datasets\emot2\emot2_train.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"text",outputColumnName:@"text")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.03363186F,L2Regularization=1.164906F,LabelColumnName=@"label",FeatureColumnName=@"Features"}))      
